  ...
  class << self
    def icon_codes
      %w[
        ...
        pencil phone tv piggy-bank pill pizza plane plug power printer puzzle receipt
        ...
        video wallet waves wifi wine wrench zap shopping-basket trending-up martini
        tree-palm unplug party-popper hand-heart heart-handshake tablet-smartphone circle-parking
        receipt-text handshake undo-2 hotel flower-2 calendar-heart percent popcorn gem]
    end
